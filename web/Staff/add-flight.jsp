<%-- 
    Document   : add-flight
    Created on : 20-Apr-2021, 21:01:24
    Author     : maduh
--%>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                              <label class="bmd-label-floating">Flight ID</label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                  <label class="bmd-label-floating">Travel Period</label>
                                  <input type="text" class="form-control">
                                </div>
                              </div>
                              <div class="col-md-3">
                                  <div class="form-group">
                                    <label class="bmd-label-floating">Operated By</label>
                                    <input type="text" class="form-control">
                                  </div>
                                </div>
