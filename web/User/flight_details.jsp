<%-- 
    ...
    Created on : 20-Apr-2021, 20:56:45
    Author     : maduh
--%>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="room-details-item">
                        ...
                        <div class="rd-text">
                            <div class="rd-title">
                                <h2>Colombo to London</h2>
                                <div class="rdt-right">
                                   
                                   
                                </div>
                            </div>
                            <h3>Economy from 650$ | Premium from 950$ | Business from 1850$</h3>
                            <table>
                                    <tbody>
                                            <tr>
                            ...
                            <p class="f-para">Safety.
                                    flights will perform perfectly according to COVID-19 safety measures.<p>
                                    
                                    Guaranteed flexibility
                                    For tickets issued by 30 April 2021 for travel completed by 31 December 2021. Conditions apply.<p>
                                    
                                    Unlimited changes and ticket refunds
                                    No change fees, no cancellation fees. Only pay the difference if your new flight costs more.<p>
                                    
                                    Highest hygiene standards
                                    Travel with peace of mind in a hygienic cabin environment.
                            </p>
                        </div>
                    </div>
