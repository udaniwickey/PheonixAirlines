<%-- 
    Document   : register
    Created on : 20-Apr-2021, 20:58:20
    Author     : maduh
--%>
                ...
                <div class="col-lg-6">
                    <div class="booking-form">
                        ...
                        <form action="#">
                            ...
                            <div class="check-date">
                                <label for="date-in">Telephone</label>
                                <input type="text" name="tele">
                               
                            </div>
                            <div class="check-date">
                                <label for="date-in">Username</label>
                            ...
                            <div class="check-date">
                                <label for="date-in">Re-Type Password</label>
